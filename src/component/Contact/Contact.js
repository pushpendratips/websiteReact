            ...
            <div className='left'>
              <div className='box box_shodow'>
                ...
                <div className='details'>
                  ...
                  <p>Email: trippushpender195@gmail.com</p> <br />
            ...
            <div className='right box_shodow'>
              <form onSubmit={formSubmit}>
                ...
                <div className='input'>
                  ...
                  <textarea cols='10' rows='9' name='message' value={data.message} onChange={InputEvent}></textarea>
                </div>
                <button className='btn_shadow1111'>
